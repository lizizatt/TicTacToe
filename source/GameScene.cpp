...
{
	cubes.push_back(std::make_shared<Cube>(glm::vec3(-1, -1, 0), glm::vec3(.5, .5, .5), position, scale));
	cubes.push_back(std::make_shared<Cube>(glm::vec3(0, -1, 0), glm::vec3(.5, .5, .5), position, scale));
	cubes.push_back(std::make_shared<Cube>(glm::vec3(1, -1, 0), glm::vec3(.5, .5, .5), position, scale));

	cubes.push_back(std::make_shared<Cube>(glm::vec3(-1, 0, 0), glm::vec3(.5, .5, .5), position, scale));
	cubes.push_back(std::make_shared<Cube>(glm::vec3(0, 0, 0), glm::vec3(.5, .5, .5), position, scale));
	cubes.push_back(std::make_shared<Cube>(glm::vec3(1, 0, 0), glm::vec3(.5, .5, .5), position, scale));
